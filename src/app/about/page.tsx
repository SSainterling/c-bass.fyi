...
export const metadata: Metadata = {
    title: "About | Sebastian Sainterling",
    description:
        "Atlanta-based Software Engineer and a Content Creator, sharing insights on well-designed products and technology advancements.",
};
